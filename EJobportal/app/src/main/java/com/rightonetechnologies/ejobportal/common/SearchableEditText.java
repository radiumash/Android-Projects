...
import com.rightonetechnologies.ejobportal.R;
import java.util.ArrayList;
import java.util.List;

public class SearchableEditText extends androidx.appcompat.widget.AppCompatEditText implements View.OnTouchListener, SearchableListDialog.SearchableItem{
