...
import com.rightonetechnologies.wholesalebazzar.activity.*;
...
public class SessionManager {
    ...
    public static final String KEY_STAR = "isstar";
     ...
     * */
    public void createLoginSession(String uid, String cid, String mobile, String name, String star, String referral){
        ...
        // Storing isstar in pref
        editor.putString(KEY_STAR, star);

        // Storing referral_code in pref
