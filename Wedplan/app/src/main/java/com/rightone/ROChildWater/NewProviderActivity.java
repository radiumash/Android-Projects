    ...
    public void saveProvider() {
        if (!cr.isConnected()) {
            ...
            if (mProPicS.trim().length() == 0) {
                ...
                error = true;
                Toast.makeText(this, getString(R.string.chk_user), Toast.LENGTH_SHORT).show();
            } else if (!cr.isConnected()) {
                error = true;
                Toast.makeText(this, getString(R.string.check_internet), Toast.LENGTH_SHORT).show();
            } else {
                SaveProvider sp = new SaveProvider();
                sp.execute(mProNameS, mSpecialityS, mBusinessNameS, mAddressS, mPhoneS, mMobileS, mZipS, mLatitudeS, mLongitudeS, myStateS, myServiceS, mySubscriptionS, mCityS, mLocalityS, mProPicS, mBusinessPicS, userId, mDescriptionS, mEmailS, mWebsiteS);
            }
            if(error){
                mDialog.setVisibility(View.INVISIBLE);
            }
    ...
    public class SaveProvider extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                multipart.addFormField("user_id", mUserS);
                multipart.addFormField("executive_id", "0");
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if(aBoolean){
                mDialog.setVisibility(View.INVISIBLE);
                Toast.makeText(getApplicationContext(),getString(R.string.listing_success),Toast.LENGTH_LONG).show();
                try {
            ...
            try {
                ...
                try {
                    ...
                    if (success.equals(true)) {
                        ...
                        stateArrayAdapt = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_list_item_1,stateArray);
                        ...
                        categoryArrayAdapter = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_list_item_1,categoryArray);
                        ...
                        for(int i=0;i<subscriptions.length();i++){
                            ...
                            subscriptionArray[i+1] = subscriptions.getJSONObject(i).getString("subscription_title") + " [₹ " +
                                    subscriptions.getJSONObject(i).getString("amount") + "], VR 360 Photo: " +
                                    subscriptions.getJSONObject(i).getString("no_of_images");
                        }

                        subscriptionArrayAdapter = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_list_item_1,subscriptionArray);
                ...
                try {
                    ...
                    try {
                        ...
                        if (success.equals(true)) {
                            ...
                            serviceArrayAdapter = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_spinner_item, serviceArray);
                        }
                        return true;
                    } catch (JSONException e) {
                        e.printStackTrace();
                ...
                try {
                    ...
                    try {
                        ...
                        if (success.equals(true)) {
                            ...
                            cityArrayAdapt = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_spinner_item, cityArray);
                        }
                        return true;
                    } catch (JSONException e) {
                        e.printStackTrace();
                ...
                try {
                    ...
                    try {
                        ...
                        if (success.equals(true)) {
                            ...
                            localityArrayAdapter = new ArrayAdapter(NewProviderActivity.this, android.R.layout.simple_list_item_1, localityArray);
                        }
                        return true;
                    } catch (JSONException e) {
                        e.printStackTrace();
