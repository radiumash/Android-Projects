...
public class ChapterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(favourite.equals("2")){
            this.setTitle(getString(R.string.my_favourite) + " " + getString(R.string.chapter));
            ...
            try {
                ...
                try {
                    if (favourite.equals("2")) {
                        ...
                        postDataParams.put("chapterids", providerString);
                    } else {

                        postDataParams.put("classid", mCid);
                        postDataParams.put("subjectid", mSubject);
                    }
                } catch (NullPointerException e){
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    if (success.equals(true)) {
                        ...
                        for (int i = 0; i < accounts.length(); i++) {
                            ...
                            String chapterDesc = accounts.getJSONObject(i).getString("chapterdescription" + lName);
                            String subjectId = accounts.getJSONObject(i).getString("subjectid");
                            String subjectName = accounts.getJSONObject(i).getString("subjectname" + lName);
