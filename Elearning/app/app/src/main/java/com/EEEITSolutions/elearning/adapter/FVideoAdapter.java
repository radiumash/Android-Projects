...
public class FVideoAdapter extends BaseAdapter implements Filterable{
    ...
    public FVideoAdapter(Context context, ArrayList<VideoDetails> providerArrayList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(db.getFavouriteFVideo(pro_id)) {
