...
public class VideosSubjectWiseActivity extends AppCompatActivity {

    private String chapter_id, chapter_name;
    SessionManager session;
    GetVideosByChapter getP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_subjectwise);
        ...
        if(!chapter_name.isEmpty()){
            this.setTitle(chapter_name + ": " + getString(R.string.videos));
        }
        ...
        getP = new GetVideosByChapter(chapter_id);
     ...
     */
    public class GetVideosByChapter extends AsyncTask<Void, Void, Boolean> {
        ...
        GetVideosByChapter(String chapter_id) {
            ...
            try {
                ...
                try {
                    if (favourite.equals(true)) {
                        ...
                        url = getString(R.string.server_url) + "chaptervideolist";
                ...
                try {
                    ...
                    if (success.equals(true)) {
                        ...
                        for (int i = 0; i < accounts.length(); i++) {
                            ...
                            String topicName = accounts.getJSONObject(i).getString("topicname");
                            String videoID = accounts.getJSONObject(i).getString("videoid");
                            String videoName = accounts.getJSONObject(i).getString("videoname");
