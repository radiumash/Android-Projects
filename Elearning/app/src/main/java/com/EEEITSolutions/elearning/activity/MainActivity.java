                ...
                try {
                    ...
                    if (success.equals(true)) {
                        ...
                        for (int i = 0; i < subjects.length(); i++) {
                            ...
                            images.add(url);
                            names.add( subjects.getJSONObject(i).getString("subjectname"));
                        ...
                        for (int i = 0; i < recentV.length(); i++) {
                            ...
                            bName.add(recentV.getJSONObject(i).getString("videoname"));
                        ...
                        for (int i = 0; i < topV.length(); i++) {
                            ...
                            bName1.add(topV.getJSONObject(i).getString("videoname"));
                        ...
                        for (int i = 0; i < latestV.length(); i++) {
                            ...
                            bName2.add(latestV.getJSONObject(i).getString("videoname"));
