...
public class LoginActivity extends AppCompatActivity {
    ...
    public class checkLogin extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if(aBoolean){
                try {
                    session.createLoginSession(uObject.getString("studentid"), uObject.getString("classid"),uObject.getString("language"),uObject.getString("studentname"), uObject.getString("classname"), uObject.getString("imageurl"));
                    Toast.makeText(getApplicationContext(),"Dear " + uObject.getString("studentname") + ",\nWelcome to " + getString(R.string.app_name),Toast.LENGTH_LONG).show();
