...
public class OtpActivity extends AppCompatActivity {
    ...
    public static String PROVIDER_CONST = "PROVIDER";
                ...
                mVerifyButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (mOtp.getText().toString().equals("")) {
                            ...
                            if(!PROVIDER_CONST.equals(userType)){
                                startActivity(new Intent(getApplicationContext(), HomeActivity.class));
                                finish();
                            }else {
                                String provider_id = extra.getString("provider_id");
                                String subscription_id = extra.getString("subscription_id");
                                String executive_id = extra.getString("executive_id");
                                new SaveProvider2().execute(provider_id, subscription_id, executive_id);
                            }
                        }
                    }
                });
    ...
    public class SaveProvider2 extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                postDataParams.put("executive_id", mEid);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if(result){
                ...
                i.putExtra("MESSAGE", "Provider is active now.");
                startActivity(i);
                finish();
            }else{
