...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mMobileSignInButton = findViewById(R.id.mobile_sign_in_button);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // Select only mobile numbers.
                ContactsContract.Contacts.Data.MIMETYPE +
                        " = ?", new String[]{ContactsContract.CommonDataKinds.Email
                .CONTENT_ITEM_TYPE},

                // Show primary mobile numbers first. Note that there won't be
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                postDataParams.put("action", "login");
                ...
                try{
                    ...
                    if(success.equals(true)) {
                        ...
                        JSONObject userJSON = rootJSON.getJSONObject("results").getJSONObject("data");
                        if (userJSON.getString("id") != "") {
                            String uid = userJSON.getString("id");
                            String name = userJSON.getString("name");
                            session.createLoginSession(uid,mMobile,name);
